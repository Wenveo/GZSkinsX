...
internal unsafe sealed class KernelInterop : IDisposable
{
...
#pragma warning restore format
    ...
    public void EncryptConfigText(void* text, void** dst)
    {
        _encryptConfigTextFunc(text, dst);
    }

    public void DecryptConfigText(void* text, void** dst)
    {
        _decryptConfigTextFunc(text, dst);
    }
    ...
    public uint ReadLegacySkinImage(void* handle, void** buffer, int* length)
    {
        return _readLegacySkinImageFunc(handle, buffer, length);
    }

    public uint ReadLegacySkinInfo(void* handle, void** skinInfoPtr)
    {
        return _readLegacySkinInfoFunc(handle, skinInfoPtr);
    }
    ...
    private unsafe delegate void EncryptConfigTextFunc(void* text, void** dst);

    private unsafe delegate void DecryptConfigTextFunc(void* text, void** dst);
    ...
    private unsafe delegate uint ReadLegacySkinImageFunc(void* handle, void** buffer, int* length);

    private unsafe delegate uint ReadLegacySkinInfoFunc(void* handle, void** skinInfoPtr);
}
