...
internal sealed class NavigationViewManager : INavigationViewManager
{
    ...
    /// </para>
    /// </summary>
    private NavigationViewItem? _navItemFromCore;
    ...
    private void OnNavSelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
    {
        ...
        Debug.Assert(ctx.Metadata.PageType is not null);
    ...
    private NavigationViewItem? FindNavItem(ref Guid guid)
    {
        static NavigationViewItem? FindSubNavItem(IEnumerable<object> items, ref Guid guid)
        {
