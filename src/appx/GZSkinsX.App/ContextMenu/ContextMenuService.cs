...
internal sealed class ContextMenuService : IContextMenuService
{
    ...
    private static void SetCommonUIProperties(MenuFlyoutItem uiObject, IContextMenuItem menuItem)
    {
    ...
    private static MenuFlyoutItem CreateMenuItem(IContextMenuItem menuItem)
    {
    ...
    private static ToggleMenuFlyoutItem CreateToggleMenuItem(IContextToggleMenuItem toggleMenuItem)
    {
        static void OnClick(object sender, RoutedEventArgs e)
        {
    ...
    private static RadioMenuFlyoutItem CreateRadioMenuItem(IContextRadioMenuItem radioMenuItem)
    {
        static void OnClick(object sender, RoutedEventArgs e)
        {
            var self = (RadioMenuFlyoutItem)sender;
        ...
        var radioMenuFlyoutItem = new RadioMenuFlyoutItem { DataContext = radioMenuItem };
        ...
        static void OnOpening(object? sender, object e)
        {
            static void InitializeSubItem(MenuFlyoutItemBase item, IContextMenuUIContext uiContext)
            {
                ...
                if (item is MenuFlyoutItem menuFlyoutItem)
                {
                    ...
                    else if (item is RadioMenuFlyoutItem radioMenuFlyoutItem)
                    {
            ...
            if (self is not null)
            {
                ...
                var uiContext = callback is not null ? callback(self, e) : new ContextMenuUIContext(self, e);
