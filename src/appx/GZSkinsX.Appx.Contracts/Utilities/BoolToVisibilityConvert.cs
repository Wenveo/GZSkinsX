...
namespace GZSkinsX.Contracts.Utilities;

/// <summary>
/// 提供对 <see cref="bool"/> 和 <see cref="Visibility"/> 类型相互转换的方法。
/// </summary>
public static class BoolToVisibilityConvert
{
    ...
    public static bool ToBooleanNegation(Visibility value)
    {
    ...
    public static Visibility ToVisibilityNegation(bool value)
    {
