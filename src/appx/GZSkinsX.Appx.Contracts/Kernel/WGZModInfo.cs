...
public record struct WGZModInfo(string Name, string Author, string Description, string DateTime)
{
    /// <summary>
    /// 表示空的模组信息。
    /// </summary>
    public static readonly WGZModInfo Empty = new();
    ...
    public static bool IsEmpty(in WGZModInfo modInfo)
    {
