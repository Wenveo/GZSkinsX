...
#pragma warning disable format
    ...
    protected override void OnApplyTemplate()
    {
        ...
        if (_secondaryButton is not null)
        {
            ...
            var secondaryName = AppxContext.MRTCoreService.MainResourceMap
                .GetString("GZSkinsX.Appx.Contracts/Resources/MultiStateToggleButtonSecondaryButtonName");
...
#pragma warning restore format
    ...
    private void OnPointerEvent(object sender, PointerRoutedEventArgs e)
    {
        ...
        {
            _lastPointerDeviceType = (PointerDeviceType)pointerDeviceType;
            UpdateVisualStates();
        }
    }
