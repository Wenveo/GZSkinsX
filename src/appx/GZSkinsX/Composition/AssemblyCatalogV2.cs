...
internal sealed class AssemblyCatalogV2 : IEquatable<AssemblyCatalogV2>
{
    ...
    /// <summary>
    /// 将程序集添加到集合并返回自身 <see cref="AssemblyCatalogV2"/>。
    /// </summary>
    /// <param name="assemblys">将要被添加的程序集。</param>
    /// <returns>自身容器对象 <see cref="AssemblyCatalogV2"/>。</returns>
    ...
    /// <summary>
    /// 将类型所处的程序集添加到集合并返回自身 <see cref="AssemblyCatalogV2"/>。
    /// </summary>
