...
public static partial class CompositionExtensions
{
    ...
    public static CubicBezierEasingFunction CreateCubicBezierEasingFunction(this Compositor c, float x1, float y1, float x2, float y2) => c.CreateCubicBezierEasingFunction(new Vector2(x1, y1), new Vector2(x2, y2));

    public static CubicBezierEasingFunction CreateCubicBezierEasingFunction(this Compositor c, KeySpline spline) => c.CreateCubicBezierEasingFunction(spline);

    public static CubicBezierEasingFunction CreateEntranceEasingFunction(this Compositor c) => c.CreateCubicBezierEasingFunction(new Vector2(.1f, .9f), new Vector2(.2f, 1));

    public static ColorKeyFrameAnimation CreateColorKeyFrameAnimation(this CompositionObject obj, string? targetProperty = null) => obj.TryAddGroup(obj.Compositor.CreateColorKeyFrameAnimation().SetSafeTarget(targetProperty));

    public static ExpressionAnimation CreateExpressionAnimation(this CompositionObject obj) => obj.TryAddGroup(obj.Compositor.CreateExpressionAnimation());

    public static ExpressionAnimation CreateExpressionAnimation(this CompositionObject obj, string targetProperty) => obj.TryAddGroup(obj.Compositor.CreateExpressionAnimation().SetTarget(targetProperty));

    public static QuaternionKeyFrameAnimation CreateQuaternionKeyFrameAnimation(this CompositionObject obj, string? targetProperty = null) => obj.TryAddGroup(obj.Compositor.CreateQuaternionKeyFrameAnimation().SetSafeTarget(targetProperty));

    public static SpringVector3NaturalMotionAnimation CreateSpringVector3Animation(this CompositionObject obj, string? targetProperty = null) => obj.TryAddGroup(obj.Compositor.CreateSpringVector3Animation().SetSafeTarget(targetProperty));

    public static ScalarKeyFrameAnimation CreateScalarKeyFrameAnimation(this CompositionObject obj, string? targetProperty = null) => obj.TryAddGroup(obj.Compositor.CreateScalarKeyFrameAnimation().SetSafeTarget(targetProperty));
    public static Vector2KeyFrameAnimation CreateVector2KeyFrameAnimation(this CompositionObject obj, string? targetProperty = null) => obj.TryAddGroup(obj.Compositor.CreateVector2KeyFrameAnimation().SetSafeTarget(targetProperty));

    public static Vector3KeyFrameAnimation CreateVector3KeyFrameAnimation(this CompositionObject obj, string? targetProperty = null) => obj.TryAddGroup(obj.Compositor.CreateVector3KeyFrameAnimation().SetSafeTarget(targetProperty));

    public static Vector4KeyFrameAnimation CreateVector4KeyFrameAnimation(this CompositionObject obj, string? targetProperty = null) => obj.TryAddGroup(obj.Compositor.CreateVector4KeyFrameAnimation().SetSafeTarget(targetProperty));
    ...
    public static UIElement EnableCompositionTranslation(this UIElement element) => EnableCompositionTranslation(element, null);

    public static UIElement EnableCompositionTranslation(this UIElement element, float x, float y, float z) => EnableCompositionTranslation(element, new Vector3(x, y, z));
    ...
    public static T GetCached<T>(this CompositionObject c, string key, Func<T> create) where T : CompositionObject => CompositionObjectPool.Shared.GetCached(c, key, create);

    public static T GetCached<T>(this Compositor c, string key, Func<T> create) where T : CompositionObject => CompositionObjectPool.Shared.GetCached(c, key, create);

    public static CubicBezierEasingFunction GetCachedEntranceEase(this Compositor c) => c.GetCached("EntranceEase", c.CreateEntranceEasingFunction);
    ...
    {
        _ = visual.Properties.TryGetVector3(CompositionFactory.TRANSLATION, out var translation);
        return translation;
    }
    ...
    public static Visual SetCenterPoint(this Visual visual, float x, float y, float z) => SetCenterPoint(visual, new Vector3(x, y, z));
    ...
    public static Visual SetCenterPoint(this Visual visual) => SetCenterPoint(visual, new Vector3(visual.Size / 2f, 0f));
    ...
    public static T SetDuration<T>(this T animation, double duration) where T : KeyFrameAnimation => duration >= 0 ? SetDuration(animation, TimeSpan.FromSeconds(duration)) : animation;
    ...
    public static SpringVector3NaturalMotionAnimation SetPeriod(this SpringVector3NaturalMotionAnimation animation, double duration) => duration >= 0 ? SetPeriod(animation, TimeSpan.FromSeconds(duration)) : animation;
    ...
    public static Visual SetTranslation(this Visual visual, float x, float y, float z) => SetTranslation(visual, new Vector3(x, y, z));
    ...
    {
        _ = SetImplicitAnimation(GetElementVisual(element), path, animation);
        return element;
    }
    ...
    public static T SetImplicitAnimation<T>(this T obj, string path, ICompositionAnimationBase? animation) where T : CompositionObject
    {
        ...
        if (animation == null)
        {
            _ = obj.ImplicitAnimations.Remove(path);
        }
        else
        {
    ...
    public static void StartAnimation(this CompositionObject obj, CompositionAnimationGroup animation) => obj.StartAnimationGroup(animation);
    ...
    public static Visual WithStandardTranslation(this Visual visual)
        => CompositionFactory.EnableStandardTranslation(visual);
}
