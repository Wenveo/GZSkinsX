...
public static partial class CompositionExtensions
{
    ...
    public static ContainerVisual GetContainerVisual(this UIElement element)
    {
        ...
        _ = container.LinkSize(elementVisual);
        _ = element.SetChildVisual(container);
        return container;
    }
    ...
    public static bool IsTranslationEnabled(this UIElement element) => GetElementVisual(element).Properties.TryGetVector3(CompositionFactory.TRANSLATION, out _) != CompositionGetValueStatus.NotFound;
    ...
    public static void SetHideAnimation<T>(this T element, ICompositionAnimationBase? animation) where T : UIElement => ElementCompositionPreview.SetImplicitHideAnimation(element, animation);

    public static void SetShowAnimation<T>(this T element, ICompositionAnimationBase? animation) where T : UIElement => ElementCompositionPreview.SetImplicitShowAnimation(element, animation);
