...
internal sealed class SettingsService : ISettingsService
{
    ...
    /// <inheritdoc/>
    public void DeleteSection(string name) => _localSettingsSection.GetOrCreateSection(name);
    ...
    /// <inheritdoc/>
    public ISettingsSection GetOrCreateSection(string name) => _localSettingsSection.GetOrCreateSection(name);
