...
public partial class GridSplitter : Control
{
    ...
    internal static readonly CoreCursor s_columnsSplitterCursor = new(CoreCursorType.SizeWestEast, 1);
    internal static readonly CoreCursor s_rowSplitterCursor = new(CoreCursorType.SizeNorthSouth, 1);
    ...
    public GridSplitter()
    {
        ...
        AutomationProperties.SetName(this, nameof(GridSplitter));
    }
