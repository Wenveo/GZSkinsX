...
namespace GZSkinsX.Uwp.UI.Toolkit.Extensions;
...
public static class DispatcherQueueExtensions
{
    ...
    /// </summary>
    private static readonly bool s_isHasThreadAccessPropertyAvailable = ApiInformation.IsMethodPresent("Windows.System.DispatcherQueue", "HasThreadAccess");
    ...
    public static Task EnqueueAsync(this DispatcherQueue dispatcher, Action function, DispatcherQueuePriority priority = DispatcherQueuePriority.Normal)
    {
        ...
        if (s_isHasThreadAccessPropertyAvailable && dispatcher.HasThreadAccess)
        {
            try
            {
                function();
